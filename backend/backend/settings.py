...
SECRET_KEY = 'django-insecure-%k^768m#7c4jbx=0acf1%k4%4-dgb^##(d8!f6z885(8m_+v$&'
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 10,  # Or whatever number suits your UI
}
...
CURRENT_DB = config('CURRENT_DB', default='sqlite')
# Set the actual default database based on CURRENT_DB
...
EMAIL_HOST = config('EMAIL_HOST', default='smtp.gmail.com')  # or your email host
